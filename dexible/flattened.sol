...
// File contracts/libs/LibAccess.sol
...
// File contracts/libs/LibStorage.sol
...
// File contracts/libs/LibConfig.sol
...
// File contracts/deployment/SettlementAdmin.sol
...
// File contracts/deployment/ZrxAdmin.sol
...
// File contracts/interfaces/uniswap/IV2Router.sol
...
// File contracts/routers/zrx/ZrxRouter.sol
...
contract Settlement is BaseConfig {
    ...
    uint256 constant GAS_OVERHEAD = 80_000;
    ...
    function fill(Types.Order memory order, IDexRouter router, bytes calldata data) public onlyRelay nonReentrant {
        ...
        uint256 startGas = gasleft().add(55_000);
    ...
    function _trySwap(Types.Order calldata order, IDexRouter router, bytes calldata data) external returns (bool success, string memory failReason) {
        ...
        (bool s,) = swapTarget.call{gas: gasleft()}(data);
...
// File contracts/interfaces/uniswap/IPair.sol
...
// File contracts/interfaces/uniswap/IPairFactory.sol
